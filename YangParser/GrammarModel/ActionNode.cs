...
/// <summary>Action associated with container of list.</summary>
public class ActionNode : IIdentifiableNode
{
    ...
    /// <summary>List of features that server must support in order to use this action.</summary>
    public List<string> IfFeatures { get; set; } = new();

    /// <summary>List of type definitions.</summary>
    ...
    /// <summary>Description of input argument.</summary>
    public InputNode? Input { get; set; }

    /// <summary>Description of output.</summary>
