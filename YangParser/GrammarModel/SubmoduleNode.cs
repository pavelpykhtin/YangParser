...
public class SubmoduleNode : IIdentifiableNode
{
    ...
    /// <summary>Namesapce of the submodule.</summary>
    public string YangVersion { get; set; } = null!;

    /// <summary>Party responsible for this submodule.</summary>
    public string? Organization { get; set; }

    /// <summary>Contact information of the party responsible for the submodule.</summary>
    public string? Contact { get; set; }

    /// <summary>Description of the submodule.</summary>
    ...
    /// <summary>History of changes of submodule.</summary>
